...
// If the i-th bit is 1, then the i-th byte character is a special character that
// needs to be escaped.
...
// escapePattern returns a string that escapes all regex metacharacters inside the string;
